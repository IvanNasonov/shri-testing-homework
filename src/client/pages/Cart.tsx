...
export const Cart: React.FC = () => {
  ...
  if (!cartIsEmpty) {
    ...
    content = (
      <table className={bem("Table", ["table"])} data-testid="cart-items">
        <thead>
          <tr>
            <th scope="col">#</th>
        ...
        <tfoot>
          <tr>
            ...
            <td className={bem("OrderPrice")} data-testid="cart-total">
              ${total}
            </td>
          </tr>
        </tfoot>
    ...
    content = (
      <>
        ...
        <Link data-testid="catalog-link" to="/catalog">
          catalog
        </Link>
        .
      </>
  ...
  const form = cartIsEmpty ? null : (
    <div className="row" data-testid="checkout-form-container">
